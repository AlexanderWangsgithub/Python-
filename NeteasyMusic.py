...
querystring = {"id": "1899031", "order": "0", "_hash": "programlist", "limit": "100", "offset": "0"}
...
for i in re_re_list:
    #使用uget提供的爬虫
    command = "/Users/wanggang/workspace/Tools/you-get/you-get -o /Users/wanggang/Music/common/guitar_durian " + i
    print(command)
    os.system(command)
    count = count + 1
